...
int main()
{
	...
	cout <<"How many hours did you work:"; cin>> hoursWorked;
	cout <<"What was your hourly rate:$"; cin>> payRate;
	...
	cout <<"Clothes & Accesories:$" <<clothesAmount <<endl;
	cout <<"School Supplies:$" <<schoolAmount <<endl;
	cout <<"Saving Bonds:$" <<bondsAmount <<endl;
